...
public class ContainsAttributeFilterFactory {
	...
	public static enum Contains {
		Images, Audio, Ink, EncryptedText, Todo, UnfinishedTodo, FinishedTodo, Attachment, PDF
	};

	public static ContainsAttributeFilter create(Contains fType) {
		switch (fType) {
		case Images:
			return new ContainsAttributeFilterMime(QCoreApplication.translate(
					"cx.fbn.nevernote.filters.ContainsAttributeFilter",
					"Images"), "image/");
		case Audio:
			return new ContainsAttributeFilterMime(
					QCoreApplication.translate(
							"cx.fbn.nevernote.filters.ContainsAttributeFilter",
							"Audio"), "audio/");
		case Ink:
			return new ContainsAttributeFilterMime(QCoreApplication.translate(
					"cx.fbn.nevernote.filters.ContainsAttributeFilter", "Ink"),
					"application/vnd.evernote.ink");
		case EncryptedText:
			return new ContainsAttributeFilterContent(
					QCoreApplication.translate(
							"cx.fbn.nevernote.filters.ContainsAttributeFilter",
		...
		case Todo:
			return new ContainsAttributeFilterContent(
					QCoreApplication.translate(
							...
							"ToDo Items"), "<en-todo");
		case UnfinishedTodo:
			return new ContainsAttributeFilterTodo(QCoreApplication.translate(
					"cx.fbn.nevernote.filters.ContainsAttributeFilter",
		...
		case Attachment:
			return new ContainsAttributeFilterAttachment(
					QCoreApplication.translate(
							"cx.fbn.nevernote.filters.ContainsAttributeFilter",
							"Attachment"));
		case PDF:
			return new ContainsAttributeFilterMime(QCoreApplication.translate(
					"cx.fbn.nevernote.filters.ContainsAttributeFilter", "PDF"),
					"application/pdf");
		}
