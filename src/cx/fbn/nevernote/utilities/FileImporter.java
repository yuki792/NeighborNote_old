...
public class FileImporter {
	...
	public boolean importTextFile() {
		...
		if (!file.open(new QIODevice.OpenMode(QIODevice.OpenModeFlag.ReadOnly))) {
			...
			logger.log(logger.LOW,
					"Unable to save externally edited file - locked.  Saving for later.");
			return false;
		}
		...
		if (binData.size() == 0) {
			...
			// again later.
			logger.log(logger.LOW,
					"Unable to save externally edited file - zero size.  Saving for later.");
			return false;
		}
		...
		noteString = new String(
				"<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
						+ "<!DOCTYPE en-note SYSTEM \"http://xml.evernote.com/pub/enml2.dtd\">\n"
						+ "<en-note>\n<br clear=\"none\" />" + fileData
						+ "</en-note>");
	...
	/**
	 * find the appropriate icon for an attachment NFC TODO: duplicate of
	 * {@link NeverNote#findIcon(String)}
	 */
