...
public class MainMenuBar extends QMenuBar {
	...
	public QAction fullReindexAction; // Action when a user wants to reindex the
										// entire database
	public QAction synchronizeAction; // Synchronize data with Evernote
	public QAction selectiveSyncAction; // Specify which notebooks or tags to
										// ignore
	...
	public QAction emptyTrashAction; // Action when a user wants to clear the
										// trash file
	...
	public MainMenuBar(NeverNote p) {
		...
		noteRestoreAction
				.setToolTip(tr("Restore a deleted file from the trash"));
		...
		hideSavedSearches.triggered
				.connect(parent, "toggleSavedSearchWindow()");
		...
		savedSearchDeleteAction.triggered
				.connect(parent, "deleteSavedSearch()");
		...
		synchronizeAction
				.setToolTip("Delete all local data & get a fresh copy");
		...
		databaseStatusAction
				.setToolTip(tr("Show current database information"));
		...
		encryptDatabaseAction
				.setToolTip(tr("Encrypt the database upon shutdown"));
		...
		if (Global.cipherPassword != null && Global.cipherPassword != "") {
			...
			encryptDatabaseAction
					.setToolTip("Decrypt the database upon shutdown");
		}
