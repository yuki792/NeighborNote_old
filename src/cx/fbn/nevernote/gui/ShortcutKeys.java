...
public class ShortcutKeys {
	...
	public String View_Show_Attribute_Searches; // Show the attribute selection
												// tree
	...
	public ShortcutKeys() {
		...
		File_Notebook_Open = new String(); // Open a closed (i.e. archived)
											// notebook
		...
		Edit_Find_In_Note = new String("Ctrl+F"); // Search only within the
													// current note
		Edit_Undo = new String("Ctrl+Z"); // Undo last change
		Edit_Redo = new String("Ctrl+Y"); // Redo the last undone change
		Edit_Cut = new String("Ctrl+X"); // Cut current selection to the
											// clipboard
		Edit_Copy = new String("Ctrl+C"); // Copy the current selection to the
											// clipboard
		Edit_Paste = new String("Ctrl+V"); // Paste
		Edit_Paste_Without_Formatting = new String("Ctrl+Shift+P"); // Paste as
																	// plain
																	// text
		...
		View_Extended_Information = new String("F8"); // View details on the
														// current note
		...
		View_Show_Attribute_Searches = new String(); // Show the attribute
														// selection tree
		View_Show_SavedSearches = new String(); // Show the saved search tree
		View_Show_Trash = new String(); // Show the trash window
		View_Show_Editor_Button_Bar = new String(); // Hide the editor button
													// bar
		...
		Format_Indent_Increase = new String("Ctrl+M"); // Increase the
														// indentation
		Format_Indent_Decrease = new String("Ctrl+Shift+M"); // Decrease the
																// indent
