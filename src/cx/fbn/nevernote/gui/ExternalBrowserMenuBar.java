...
public class ExternalBrowserMenuBar extends QMenuBar {
	...
	public QAction printAction; // Action when a user selects Print from the
								// file menu
	...
	public ExternalBrowserMenuBar(ExternalBrowse p) {
		...
		editPaste.triggered
				.connect(parent.getBrowserWindow(), "pasteClicked()");
		setupShortcut(editPaste, "Edit_Paste");

		editPasteWithoutFormat = new QAction(tr("Paste Without Formatting"),
				this);
		editPasteWithoutFormat.setToolTip(tr("Paste Without Formatting"));
		editPasteWithoutFormat.triggered.connect(parent.getBrowserWindow(),
		...
		alignLeftAction.triggered.connect(parent.getBrowserWindow(),
				"justifyLeftClicked()");
		...
		alignRightAction.triggered.connect(parent.getBrowserWindow(),
				"justifyRightClicked()");
		...
		alignCenterAction.triggered.connect(parent.getBrowserWindow(),
		...
		formatBold.triggered
				.connect(parent.getBrowserWindow(), "boldClicked()");
		...
		formatItalic.triggered.connect(parent.getBrowserWindow(),
				"italicClicked()");
		...
		formatUnderline.triggered.connect(parent.getBrowserWindow(),
				"underlineClicked()");
		...
		formatSuperscript.triggered.connect(parent.getBrowserWindow(),
				"superscriptClicked()");
		...
		formatSubscript.triggered.connect(parent.getBrowserWindow(),
				"subscriptClicked()");
		...
		formatStrikethrough.triggered.connect(parent.getBrowserWindow(),
		...
		horizontalLineAction.triggered.connect(parent.getBrowserWindow(),
				"hlineClicked()");
		...
		formatBulletList.triggered.connect(parent.getBrowserWindow(),
				"bulletListClicked()");
		...
		formatNumberList.triggered.connect(parent.getBrowserWindow(),
				"numberListClicked()");
		...
		indentAction.triggered.connect(parent.getBrowserWindow(),
				"indentClicked()");
		...
		outdentAction.triggered.connect(parent.getBrowserWindow(),
				"outdentClicked()");
		...
		spellCheckAction.triggered.connect(parent.getBrowserWindow(),
				"spellCheckClicked()");
