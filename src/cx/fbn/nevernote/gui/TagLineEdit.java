...
public class TagLineEdit extends QLineEdit {
	...
	public TagLineEdit(List<Tag> allTags) {
		...
		tagCompleter.highlightedIndex.connect(this,
				"completerSelected(QModelIndex)");
		changed = false;
	...
	// This method is used to store the current selection from the completer. It
	// is
	// saved until later in case focus is lost while one is selected, but Enter
	// is never pressed.
	@SuppressWarnings("unused")
	...
	public void completeText(String text) {
		...
		setText(rebuildTags(before_text + Global.tagDelimeter + text
				+ Global.tagDelimeter + after_text));
