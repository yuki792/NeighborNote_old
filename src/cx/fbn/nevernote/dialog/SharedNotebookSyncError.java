...
public class SharedNotebookSyncError extends QDialog {
	...
	public SharedNotebookSyncError(String notebook) {
		...
		msg1.setText(tr("There was an error with notebook ")
				+ notebook
		...
		deleteNotebook
				.setText(tr("Permanently delete this notebook & all notes"));
		convertToLocal = new QRadioButton(this);
		convertToLocal
				.setText(tr("Convert this notebook to a local notebook and keep all notes"));
		convertToShared = new QRadioButton(this);
		convertToShared
				.setText(tr("Convert this notebook to a shared notebook and keep all notes"));
