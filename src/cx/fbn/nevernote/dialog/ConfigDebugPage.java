...
public class ConfigDebugPage extends QWidget {
	...
	public ConfigDebugPage(QWidget parent) {
		...
		databaseCacheLayout.addWidget(new QLabel(
				tr("Database Cache (MB) - Requires restart")));
		...
		QLabel thumbnailLabel = new QLabel(
				tr("Enable Thumbnails (experimental)"));
		...
		String crlfMessage = new String(
				tr("Note: The carriage return is a test fix.  If you "
		...
		String entitiesMessage = new String(
				tr("Note: This is an experimental fix to correct Unicode"
		...
		QGroupBox refresh = new QGroupBox(
				tr("Special Refresh (WARNING - This can cause unsynchronized data loss)."));
