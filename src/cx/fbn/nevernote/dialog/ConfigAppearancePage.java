...
public class ConfigAppearancePage extends QWidget {
	...
	public ConfigAppearancePage(QWidget parent) {
		...
		mimicEvernote = new QCheckBox(
				tr("Mimic Evernote Selection Behavior (Requires Restart)"));
		...
		newNoteWithTags = new QCheckBox(
				tr("Create New Notes With Selected Tags"));
		anyTagSelection = new QCheckBox(
				tr("Display Notes Matching Any Selected Tags"));
		includeTagChildren = new QCheckBox(
				tr("Include Children In Tag Selection"));
		...
		autoSaveLayout.addWidget(new QLabel(
				tr("Automatic Save Interval (in Minutes)")));
