...
public class ConfigDialog extends QDialog {
	...
	public void okPushed() {
		...
		Global.setSynchronizeDeletedContent(connectionPage
				.getSynchronizeDeletedContent());
		Global.setTagBehavior(appearancePage.getTagBehavior());
		Global.setIndexAttachmentsLocally(indexPage
				.getIndexAttachmentsLocally());
		...
		Global.setAutomaticWildcardSearches(indexPage
				.getAutomaticWildcardSearches());
		...
		Global.setSpellSetting(Configuration.SPELL_IGNOREDIGITWORDS,
				spellPage.getIgnoreDigitWords());
		Global.setSpellSetting(Configuration.SPELL_IGNOREINTERNETADDRESSES,
				spellPage.getIgnoreInternetAddresses());
		Global.setSpellSetting(Configuration.SPELL_IGNOREMIXEDCASE,
				spellPage.getIgnoreMixedCase());
		Global.setSpellSetting(Configuration.SPELL_IGNOREUPPERCASE,
				spellPage.getIgnoreUpperCase());
		Global.setSpellSetting(
				Configuration.SPELL_IGNORESENTENCECAPITALIZATION,
				spellPage.getIgnoreSentenceCapitalization());
	...
	public void createIcons() {
		...
		formatsButton.setFlags(ItemFlag.ItemIsSelectable,
	...
	private void loadSettings() {
		...
		connectionPage.setSyncronizeDeletedContent(Global
				.synchronizeDeletedContent());
		...
		appearancePage.setShowSplashScreen(Global
				.isWindowVisible("SplashScreen"));
