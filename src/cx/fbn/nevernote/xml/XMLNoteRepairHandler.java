...
public class XMLNoteRepairHandler extends DefaultHandler {
	...
	public void stripAttribute(String attribute, int line, int column) {
		...
		String repairedFragment = fragment.substring(0, attributeStart)
				+ fragment.substring(endPos);
		repair = repair.substring(0, startPos) + repairedFragment
				+ repair.substring(column - 1);
	...
	public void error(SAXParseException e) throws EnmlException {
		...
		EnmlException e1 = new EnmlException(e.getMessage(), e.getPublicId(),
